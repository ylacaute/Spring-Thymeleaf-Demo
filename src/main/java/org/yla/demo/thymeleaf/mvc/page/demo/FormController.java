...
public class FormController extends BasePageController {
	...
	@RequestMapping(value = RequestMappingConstants.GET_LAYOUTFORM_PAGE, method = RequestMethod.GET)
	public String getDemoFormWithLayoutPage(Model model) {
		LOG.info("Display the demos form with layout page");
		ContactUsModel contactUsModel = new ContactUsModel();
		model.addAttribute("contactUsModel", contactUsModel);
		return RequestMappingConstants.LAYOUTFORM_PAGE;
	}
